...
Еще старушка не забыла
    ...
    fun baldaSearcher(baldaSearcher: (String, Set<String>) -> Set<String>) {
        ...
        assertEquals(setOf("ЧИНГИСХАН", "АРИСТОТЕЛЬ", "ВСЕЛЕННАЯ"),
                baldaSearcher("input/balda_in3.txt", setOf("ЧИНГИСХАН", "БАТЫЙ", "АРИСТОТЕЛЬ",
                        "ПЛАТОН", "ВСЕЛЕННАЯ", "ГАЛАКТИКА")))
        assertEquals(setOf("АПЕЛЬСИН", "МАРОККО", "ПЕРЕМЕНЫ", "ГРАВИТАЦИЯ",
                ...
                "ЭЙНШТЕЙН"),
                baldaSearcher("input/balda_in4.txt", setOf("АПЕЛЬСИН", "МАРОККО", "ЭФИОПИЯ", "ПЕРЕМЕНЫ", "ГРАВИТАЦИЯ",
        ...
        assertEquals(setOf(),
                baldaSearcher("input/balda_in5.txt", setOf("СИНИЙ", "БЕЛЫЙ", "ГОЛУБОЙ", "КРАСНЫЙ")))
    }
}